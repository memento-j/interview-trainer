      ...
      <Accordion type="multiple" className="space-y-5">
        {resultsData.map((result, index) => {
            return (
                ...
                >
                    {/* Question Preview */}
                    <AccordionTrigger className="text-lg hover:cursor-pointer font-semibold px-5 py-3 hover:bg-zinc-200 dark:hover:bg-zinc-950/40 transition-all rounded-t-2xl">
                        <div className="flex flex-row justify-between w-full">
                            <div className="text-base font-semibold text-foreground/90">
                                ...
                                <p className="font-normal text-[18px]">{result.question}</p>
                            </div>
